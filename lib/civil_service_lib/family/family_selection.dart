...
import '../widgets.dart';
import 'family_circulation.dart';
...
class SelectionPageState extends State<FamilySelectionPage> {
              ...
              children: [
                ...
                Row(
                  children: [
                    Text('증명서 종류'),
                    Spacer(),
                    _radioButton('일반증명서', 1),
                    SizedBox(width: 10,),
                    _radioButton('상세증명서', 1),
                    SizedBox(width: 10,),
                    _radioButton('특정증명서', 1),
                  ],
                ),
                SizedBox(height: 10,),
                Row(
                  children: [
                    Text('주민등록번호\n(뒷자리 6자리)\n공개 여부'),
                    Spacer(),
                    _radioButton('전부 비공개', 2),
                    SizedBox(width: 10,),
                    _radioButton('전부 공개', 2),
                    SizedBox(width: 10,),
                    _radioButton('신청대상자 \n본인만 공개', 2)
                  ],
                ),
