...
class ExpulsionCirculationPage extends StatefulWidget {
  final Function(Widget, double)
  switchPageCallback; // switchPageCallback을 생성자로 받음
  final double page_num;

  const ExpulsionCirculationPage({
    Key? key,
    required this.switchPageCallback,
    required this.page_num,
  }) : super(key: key);

  State createState() => ExpulsionCirculationPageState();
}

class ExpulsionCirculationPageState extends State<ExpulsionCirculationPage> {
  int circulation = 1;
