...
import 'passport_circulation.dart';
import '../widgets.dart';

class PassportSelectionPage2 extends StatefulWidget {
  final Function(Widget, double)
  switchPageCallback; // switchPageCallback을 생성자로 받음4
  final double page_num;

  const PassportSelectionPage2({
    Key? key,
...
class SelectionPage2State extends State<PassportSelectionPage2> {
