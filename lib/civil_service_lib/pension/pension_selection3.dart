...
import 'pension_circulation.dart';
import '../widgets.dart';

class PensionSelectionPage3 extends StatefulWidget {
  final Function(Widget, double)
  switchPageCallback; // switchPageCallback을 생성자로 받음4
  final double page_num;

  const PensionSelectionPage3({
    Key? key,
...
class SelectionPage3State extends State<PensionSelectionPage3> {
