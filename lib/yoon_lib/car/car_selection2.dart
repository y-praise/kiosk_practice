...
import '../car/car_circulation.dart';
import '../widgets.dart';

class CarSelectionPage2 extends StatefulWidget {
  final Function(Widget, double)
  switchPageCallback; // switchPageCallback을 생성자로 받음4
  final double page_num;

  const CarSelectionPage2({
    Key? key,
...
class SelectionPageState extends State<CarSelectionPage2> {
      ...
      children: [
        ...
        Expanded(
          child: Container(
            ...
            child: Column(
              children: [
                _radioButton('운전면허경력 기간', '전체', '5년 이내', 0),
                _radioButton('법규위반 기간', '전체', '5년 이내', 1),
                _radioButton('교통사고 기간', '전체', '5년 이내', 2),
                Row(
                  children: [
                    Text('발급사유'),
                    Spacer(),
