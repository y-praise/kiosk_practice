...
class EmploymentCirculationPage extends StatefulWidget {
  final Function(Widget, double)
  switchPageCallback; // switchPageCallback을 생성자로 받음
  final double page_num;

  const EmploymentCirculationPage({
    Key? key,
    required this.switchPageCallback,
    required this.page_num,
  }) : super(key: key);

  State createState() => HealthCirculationPageState();
}

class HealthCirculationPageState extends State<EmploymentCirculationPage> {
  int circulation = 1;
