...
class PensionCirculationPage extends StatefulWidget {
  final Function(Widget, double)
  switchPageCallback; // switchPageCallback을 생성자로 받음
  final double page_num;

  const PensionCirculationPage({
    Key? key,
    required this.switchPageCallback,
    required this.page_num,
  }) : super(key: key);

  State createState() => PensionCirculationPageState();
}

class PensionCirculationPageState extends State<PensionCirculationPage> {
  int circulation = 1;
