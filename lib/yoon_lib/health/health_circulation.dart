...
class HealthCirculationPageState extends State<HealthCirculationPage> {
  int circulation = 1;
  ...
  void initState() {
    ...
    switch (widget.page_num) {
      case 10.1:
        page_name = '4대사회보험 가입자 가입내역 확인서(개인)';
        break;

      case 10.2:
        page_name = '건강보험 자격득실확인서';
        break;
